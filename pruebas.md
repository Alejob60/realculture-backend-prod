...
curl -X POST http://localhost:3001/media/image   -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2ODA3ZmE0NC01YWU5LTQ1ZGUtYWEyNC1iZWU4NDJiNmJlY2EiLCJlbWFpbCI6ImFsZWpvYjYwMEBnbWFpbC5jb20iLCJuYW1lIjoiQWxlamFuZHJvIEJlbmF2aWRlcyIsInJvbGUiOiJGUkVFIiwiaWF0IjoxNzUxODE2ODIwLCJleHAiOjE3NTE5MDMyMjB9.JzdrPAF_w1f9W9s3OXwJWrPQoJpxc_KFN6fYKknCl4w"   -H "Content-Type: application/json"   -d '{
...
$ curl -X POST http://localhost:3001/media/video   -H "Content-Type: application/json"   -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2ODA3ZmE0NC01YWU5LTQ1ZGUtYWEyNC1iZWU4NDJiNmJlY2EiLCJlbWFpbCI6ImFsZWpvYjYwMEBnbWFpbC5jb20iLCJuYW1lIjoiQWxlamFuZHJvIEJlbmF2aWRlcyIsInJvbGUiOiJGUkVFIiwiaWF0IjoxNzUxNjY5NzA0LCJleHAiOjE3NTE3NTYxMDR9.D3aiLUGDSggOPqsYTUzHAoBowQxlbkmNRZgpDKgSLFA"   -d '{
    "prompt": "Una ciudad futurista iluminada por neones con personas caminando y drones volando",
    "useVoice": false,
    "useSubtitles": false,
    "useMusic": false,
